  ...
  >
    ...
    />
        ...
        <p className="text-muted-foreground text-sm mb-6">
          You successfully sent <span className="text-green-500 font-bold">{amount} TP</span> to{" "}
        ...
        <div className="bg-muted/50 rounded-2xl p-4 mb-6 text-left space-y-2">
          ...
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="text-green-500 font-black text-base">{amount} TP</span>
          </div>
        </div>
        <button
          onClick={onClose}
        ...
        return (
          <div key={i} className="flex items-center flex-1 last:flex-none">
            <div className="flex flex-col items-center gap-1">
              ...
              <span className={`text-[10px] font-semibold whitespace-nowrap ${active ? "text-green-500" : "text-muted-foreground"}`}>
                {label}
              </span>
            </div>
            {i < STEPS.length - 1 && (
              <div className={`flex-1 h-px mx-2 mb-4 transition-all duration-500 ${done ? "bg-green-500" : "bg-border"}`} />
            )}
          </div>
        );
      })}
    ...
    <div className="grid grid-cols-2 sm:grid-cols-2 gap-3 w-full lg:max-w-md">
      ...
      <div className="bg-card border border-border cursor-pointer rounded-2xl p-3 md:p-4 flex flex-col sm:flex-col items-start gap-3 hover:border-green-500/40 transition-all duration-300 group">
        ...
        <div className="min-w-0">
          <p className={`text-lg md:text-xl font-black leading-none ${balance > 0 ? "text-green-400" : "text-muted-foreground"}`}>
            {balance.toFixed(2)}
          </p>
              ...
              {step === "amount" && selected && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-xl bg-green-500/10 border border-green-500/20 mb-6">
                    <img src={selected.avatar} alt={selected.name} className="h-10 w-10 rounded-full object-cover border-2 border-green-500/30 shrink-0" />
                    <div className="min-w-0">
  ...
  <span className="absolute right-4 top-1/2 -translate-y-1/2 text-xs font-bold text-muted-foreground bg-muted px-2 py-1 rounded-lg">
    Task Point
                ...
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  ...
                  <div className="rounded-2xl border border-border bg-background overflow-hidden mb-6">
                    ...
                    <div className="p-4 flex items-center justify-between">
                      ...
                      <p className={`${montserrat.className} text-3xl font-black text-green-500`}>
            ...
            <p className="text-center text-xs text-muted-foreground mt-6" style={{ animation: "fadeSlideUp 0.5s ease 0.2s both" }}>
              Need help?{" "}
              <a href="#" className="text-green-500 hover:underline font-semibold cursor-pointer">Contact support</a>
            </p>
          </main>
        </div>
      </div>
